const playlist = (prefix) => {
    return `🔰 Comandos de audio e música 🔰 
...
Comando: '${prefix}autistar'
Música: Rapxis - Autistar ( Prod. pdr0sa )

Comando: '${prefix}ftuberculose'
Música: Rapxis & Gohann - Flow Tuberculose (prod. YungDrum)

Comando: '${prefix}shitpostgirl'
Música: Rapxis - Mina Shitposter (feat. Gohann)

Comando: '${prefix}yougirlistenme'
